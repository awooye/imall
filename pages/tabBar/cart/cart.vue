	...
	<view>
		...
		<view class="goods-list">
			...
			<view class="row" v-for="(item,index) in goodsList" :key="index">
				...
				<!-- 商品 -->
				<view class="container" @touchstart="handleTouchStart(index,$event)" @touchmove="handleTouchMove(index,$event)"
					...
					<view class="goods-info" @tap="handleGoodsInfo(item)">
						...
						<view class="info">
							...
							<view class="price-number">
								...
								<counter @add="add(item)" @sub="sub(item)" :goodsInfo="item"></counter>
							</view>
						</view>
					</view>
				</view>
